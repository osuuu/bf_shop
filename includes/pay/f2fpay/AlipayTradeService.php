<?php
require_once ROOT.'pay/f2fpay/lib/AopClient.php';
require_once ROOT.'pay/f2fpay/model/request/AlipayTradeCancelRequest.php';
require_once ROOT.'pay/f2fpay/model/request/AlipayTradePayRequest.php';
require_once ROOT.'pay/f2fpay/model/request/AlipayTradePrecreateRequest.php';
require_once ROOT.'pay/f2fpay/model/request/AlipayTradeQueryRequest.php';
require_once ROOT.'pay/f2fpay/model/request/AlipayTradeRefundRequest.php';
require_once ROOT.'pay/f2fpay/model/result/AlipayF2FPayResult.php';
require_once ROOT.'pay/f2fpay/model/result/AlipayF2FQueryResult.php';
require_once ROOT.'pay/f2fpay/model/result/AlipayF2FRefundResult.php';
require_once ROOT.'pay/f2fpay/model/result/AlipayF2FPrecreateResult.php';
require_once ROOT.'pay/f2fpay/model/builder/AlipayTradeQueryContentBuilder.php';
require_once ROOT.'pay/f2fpay/model/builder/AlipayTradeCancelContentBuilder.php';
require ROOT.'pay/f2fpay/config.php';
